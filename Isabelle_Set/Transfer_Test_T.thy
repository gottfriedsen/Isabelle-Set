...
imports Integer Trans.Trans HOL.Sledgehammer
begin
...
lemma Int_Rel_0 [trans_rule]: "Int_Rel (inl 0) 0"
  unfolding Int.Rep_def Int_Rel_def Int.def_def
  by (simp add: int_rep_def)

lemma Int_Rel_eq [trans_rule]: "(Int_Rel \<rightarrow> Int_Rel \<rightarrow> (=)) (=) (=)"
  unfolding rel_fun_def Int_Rel_def Int.Rep_def Int.def_def
  by auto

lemma Int_Rel_add [trans_rule]: "(Int_Rel \<rightarrow> Int_Rel \<rightarrow> Int_Rel) int_rep_add int_add"
...
lemma Int_Rel_sub [trans_rule]: "(Int_Rel \<rightarrow> Int_Rel \<rightarrow> Int_Rel) int_rep_sub int_sub"
  unfolding  rel_fun_def Int_Rel_def
  using int_sub_def Int.Abs_inverse int_sub_type
  by (metis (no_types, lifting) ElementD ElementI Pi_typeE)

lemma Int_Rel_mul [trans_rule]: "(Int_Rel \<rightarrow> Int_Rel \<rightarrow> Int_Rel) int_rep_mul int_mul"
  unfolding  rel_fun_def Int_Rel_def
  using int_mul_def Int.Abs_inverse int_mul_type
  by (metis (no_types, lifting) ElementD ElementI Pi_typeE)

lemma Int_Rel_div [trans_rule]: "(Int_Rel \<rightarrow> Int_Rel \<rightarrow> Int_Rel) int_rep_div int_div"
  unfolding  rel_fun_def Int_Rel_def
...
lemma Int_Rel_All [trans_rule]:
  "((Int_Rel \<rightarrow> (=)) \<rightarrow> (=)) (ball int_rep) (ball \<int>)"
  unfolding rel_fun_def Int_Rel_def
